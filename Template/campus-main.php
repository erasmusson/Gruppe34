...
<body id="campus">
    ...
    <?php require 'navbar.php' ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <?php require 'Campus/sidebar.php' ?>
                    ...
                    <div class="col-md-9" id="mainCol">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="pic/Fjerdingen_2.jpg" alt="Bild av Campus Fjerdingen" class="img-responsive img-rounded">
                                <a name="tokantine"></a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img alt="Bild av Campus Fjerdingen" src="pic/Fjerdingen_1.jpg" class="img-responsive img-rounded">
                                <a name="tostua"></a>
                            </div>
                        </div>
                        ...
                        <!-- Information about campus and location -->
                        <div class="row">
                            <div class="col-md-8">
